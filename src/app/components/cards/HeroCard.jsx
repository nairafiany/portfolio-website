...
export default function HeroCard({ onContactClick, onProjectsClick }) {
  ...
  const handleScenePointerMove = (event) => {
    if (
      ...
      !window.matchMedia(sceneMotionQuery).matches
    )
      return;
  ...
  return (
    <div className="hero-layout">
      ...
      >
        <div className="flex-1 order-2 md:order-1 text-center md:text-left relative z-10">
          ...
          <p className="max-w-xl mx-auto md:mx-0 text-xs sm:text-sm md:text-base leading-relaxed text-[#5f676b] mb-6">
            A lifelong learner who enjoys turning problems into things worth
            building. Mostly backend, APIs, and the systems behind them.
          </p>
        ...
        >
          ...
          >
            <figure className="editorial-journey-sheet">
              ...
              <svg
                className="editorial-journey-grid"
                viewBox="0 0 216 168"
                focusable="false"
              >
          ...
          <motion.div
            ...
            aria-hidden="true"
          >
            <span className="editorial-handnote editorial-commit-note">
              A COMMIT
              <br />
              AT A TIME
            </span>
            <svg
              className="editorial-drawn-arrow editorial-commit-arrow"
              viewBox="0 0 80 44"
              fill="none"
              focusable="false"
            >
            ...
            <span className="editorial-handnote editorial-started-note">
              JUST GETTING
              <br />
              STARTED...
            </span>
            <svg
              className="editorial-drawn-arrow editorial-started-arrow"
              viewBox="0 0 42 58"
              fill="none"
              focusable="false"
            >
            ...
            <span className="editorial-handnote editorial-more-note">
              MORE
              <br />
              TO COME
            </span>
            <svg
              className="editorial-drawn-arrow editorial-more-arrow"
              viewBox="0 0 48 58"
              fill="none"
              focusable="false"
            >
          ...
          >
            ...
            >
              <path
                className="editorial-paper-cutout"
                d="M17 9 285 3 311 26 316 134 311 253 317 404 287 423 154 418 13 427 5 316 9 191 3 40Z"
              />
          ...
          >
            <motion.div
              ...
              animate={{
                y: isCoverHovered ? -5 : 0,
                rotate: isCoverHovered ? 0 : -1,
              }}
              transition={
                prefersReducedMotion
                  ? { duration: 0 }
                  : { type: "spring", stiffness: 190, damping: 23 }
              }
            ...
            >
              <article className="comic-cover-panel">
                ...
                <div className="comic-photo-window">
                  <motion.div
                    className="cover-photo-depth cover-depth"
                  ...
                  <motion.span
                    ...
                    transition={
                      prefersReducedMotion ? { duration: 0 } : companionSpring
                    }
                    aria-hidden="true"
                  >
                    KEEP
                ...
                >
                  <span className="cover-cta-heading">
                    ...
                    <span className="cover-project-label">
                      VIEW PROJECTS{" "}
                      <span className="cover-project-arrow" aria-hidden="true">
                        ↗
                      </span>
                    </span>
                  </span>
              ...
              <article className="portfolio-insert-page">
                <header className="portfolio-insert-heading">
                  ...
                  <button
                    type="button"
                    onClick={closeInsert}
                    aria-label="Close selected projects"
                  >
                    ×
                  </button>
                </header>
                <ol className="portfolio-insert-list">
                  {selectedProjects.map((project) => (
                    <li key={project.slug}>
                      ...
                      >
                        <span
                          className="portfolio-insert-number"
                          aria-hidden="true"
                        >
                          {getProjectNumber(project.slug)}
                        </span>
                        <span>{project.title}</span>
                        <span
                          className="portfolio-insert-arrow"
                          aria-hidden="true"
                        >
                          ↗
                        </span>
      ...
      <footer className="hero-editorial-rail">
        ...
        <span className="hero-rail-folio"></span>
      </footer>
    </div>
  );
}
